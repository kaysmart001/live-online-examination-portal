...
<?php 
 if(!isset($_GET['trefaq']) && $_GET['trefaq']==NULL){
  ...
  if(($_SERVER['REQUEST_METHOD']=='POST')){
    $msg = $qs->addsubjective($_POST,$_FILES,$trefaq,$gtoken);
    if(isset($msg)){
...
<!--            <input type="text" class="form-control adgrfs" name="tfqtitle" required="1" placeholder="Question Title">-->
            <textarea class="form-control" rows="5"  name="tfqtitle" placeholder="Question Title" ></textarea>
          </div>
...
<!--
          <div class="form-group hgad">
            ...
            <input type="text" class="form-control adgrfs" name="tffiop"  placeholder="First Option" >
          </div>
          <div class="form-group hgad">
            <label style="margin-right: 48px;">Second Option: </label>
            <input type="text" class="form-control adgrfs" name="tfsiop" placeholder="Second Option">
          </div>
          <div class="form-group hgad">
            <label style="margin-right: 43px;">Correct Answer: </label>
            <input type="text" class="form-control adgrfs" name="tfcs" placeholder="Should Be Same Above Any Two Options. Otherwise Not Work.">
          </div>
-->
