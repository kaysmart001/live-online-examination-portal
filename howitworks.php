...
<!--     <div class="span10 offset1 aboutp">-->
       <h2 style="margin-bottom: 20px;font-size: 40px;">Tip's for Participants of The Exam(Examinees):</h2>
        ...
        <p><strong>7. After successfully finishing your exam,you have to wait to see the result until your admin published that result.</strong></p>
         ...
         <h2 style="margin-bottom: 20px;font-size: 40px;">Tips's for the Administrators Who Takes The Exam(Administrators):</h2>
